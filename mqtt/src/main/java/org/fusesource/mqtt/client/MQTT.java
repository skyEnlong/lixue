...
public class MQTT {
    ...
    public synchronized static ExecutorService getBlockingThreadPool() {
        if (blockingThreadPool == null) {
            blockingThreadPool = Executors.newCachedThreadPool();
        }
        return blockingThreadPool;
    }

    public synchronized static void setBlockingThreadPool(ExecutorService pool) {
    ...
    public void setBlockingExecutor(ExecutorService blockingExecutor) {
