package com.lixue.app.library.http.okhttp;
...
public class OkHttpManager {
    ...
    protected final static int TimeOut_Count = 10000;
    ...
    private OkHttpManager() {
        ...
        builder.connectTimeout(TimeOut_Count, TimeUnit.MILLISECONDS);
        builder.writeTimeout(TimeOut_Count, TimeUnit.MILLISECONDS);
        builder.readTimeout(TimeOut_Count, TimeUnit.MILLISECONDS);
