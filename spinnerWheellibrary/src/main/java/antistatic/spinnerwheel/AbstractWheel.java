...
public abstract class AbstractWheel extends View {
	...
	private boolean mItemScaleEnable = false;
	...
	private void doScroll(int delta) {
		...
		Log.d("scroll", String.valueOf(mScrollingOffset));
		int ih = getItemDimension();

		int top = (mCurrentItemIdx - mFirstItemIdx) * ih + (ih - getHeight())
				/ 2;
		Log.d("itemcount", String.valueOf(-top + mScrollingOffset));
	...
	/**
	 * Returns base dimension of the spinnerwheel ��ワ拷width for horizontal
	...
	/**
	 * Returns base dimension of base item ��ワ拷width for horizontal
	 * spinnerwheel, height for vertical
	 * 
	...
	/**
	 * Processes MotionEvent and returns relevant position ��ワ拷x for horizontal
...
//                    LinearLayout.LayoutParams.WRAP_CONTENT);
	...
	public void setItemScaleSytle(boolean enable) {
		mItemScaleEnable = enable;
	}

	protected boolean getItemScaleSytle() {
		return mItemScaleEnable;
	}

	public void setShowSplitLine(boolean showline) {
		mShowSplitLine = showline;
	}

	protected boolean getShowSplitLine() {
