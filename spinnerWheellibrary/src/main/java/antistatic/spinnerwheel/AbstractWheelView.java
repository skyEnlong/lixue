...
public abstract class AbstractWheelView extends AbstractWheel {
    ...
    //----------------------------------
    //  Default properties values7
    //----------------------------------

    protected static final int DEF_ITEMS_DIMMED_ALPHA = 80; //50, 60 in ICS

    protected static final int DEF_SELECTION_DIVIDER_ACTIVE_ALPHA = 170;

    protected static final int DEF_SELECTION_DIVIDER_DIMMED_ALPHA = 170;//70
...
//    protected static final int DEF_ITEM_PADDING = 10;
    ...
    /** Background for showing item to be selected while scrolling */
    protected Drawable mSelectionBackground;
    ...
    protected Bitmap mTxtBitmap;

    public boolean isSlectorAlpha = true;
    //--------------------------------------------------------------------------
    //
    //  Constructor
    //
    ...
    protected void initAttributes(AttributeSet attrs, int defStyle) {
        ...
        mSelectionBackground = a.getDrawable(R.styleable.AbstractWheelView_selectionBackground);
        a.recycle();
    }
    ...
    protected void initData(Context context) {
        ...
        // creating animators
        mDimSelectorWheelAnimator = ObjectAnimator.ofFloat(this, PROPERTY_SELECTOR_PAINT_COEFF, 1, 1f);//0 kevin
    ...
    protected void recreateAssets(int width, int height) {
        ...
        mTxtBitmap=Bitmap.createBitmap(width, getItemDimension(), Bitmap.Config.ARGB_8888);
