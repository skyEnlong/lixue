 ...
 */
public class NumberWheelChartAdapter extends AbstractWheelTextChartAdapter {
	 ...
	 *            the current context
	 */
	public NumberWheelChartAdapter(Context context) {
	 ...
	 */
	public NumberWheelChartAdapter(Context context, int minValue, int maxValue) {
