...
public class IntegerWheelAdapter extends AbstractWheelTextAdapter {
     ...
     */
    public IntegerWheelAdapter(Context context, int minValue, int maxValue) {
     ...
     */
    public IntegerWheelAdapter(Context context, int minValue, int maxValue, String format) {
        super(context);
    ...
    public CharSequence getItemText(int index) {
        if (index >= 0 && index < getItemsCount()) {
            int value = (int) (minValue + index*mInterval);
    ...
    public int getItemsCount() {
        return (int) ((maxValue - minValue) /mInterval+1);
    }
