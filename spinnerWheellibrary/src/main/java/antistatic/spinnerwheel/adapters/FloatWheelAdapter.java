...
public class FloatWheelAdapter extends AbstractWheelTextAdapter {
     ...
     */
    public FloatWheelAdapter(Context context, int minValue, int maxValue) {
     ...
     */
    public FloatWheelAdapter(Context context, int minValue, int maxValue, String format) {
        super(context);
    ...
    public CharSequence getItemText(int index) {
        if (index >= 0 && index < getItemsCount()) {
            float value = (float) (minValue + index*mInterval);
