...
public abstract class AbstractWheelTextAdapter extends AbstractWheelAdapter {
	...
	private int textSelectionColor = DEFAULT_TEXT_COLOR;
	private int textSelectionSize = DEFAULT_TEXT_SIZE;
	...
	public void setSelectionTextColor(int textColor) {
		this.textSelectionColor = textColor;
	}
	...
	public void setSelectionTextSize(int textSize) {
		this.textSelectionSize = textSize;
	}
...
//                textView.setTextSize(TypedValue.COMPLEX_UNIT_DIP,textSize);
				...
				textView.setText(text);
				textView.setTextColor(0xFF7c7c83);
				textView.setGravity(Gravity.CENTER);
	...
	protected void configureSelectionTextView(TextView view) {
		if (itemResourceId == TEXT_VIEW_ITEM_RESOURCE) {
			view.setTextColor(textSelectionColor);
			view.setTextSize(TypedValue.COMPLEX_UNIT_DIP,textSelectionSize);
			view.setLines(1);
		}
		if (textTypeface != null) {
			view.setTypeface(textTypeface);
